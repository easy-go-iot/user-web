...
func (x *MobilerRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MobilerRequest) ProtoMessage() {}

func (x *MobilerRequest) ProtoReflect() protoreflect.Message {
	mi := &file_user_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MobilerRequest.ProtoReflect.Descriptor instead.
func (*MobilerRequest) Descriptor() ([]byte, []int) {
	return file_user_proto_rawDescGZIP(), []int{3}
}

func (x *MobilerRequest) GetMobile() string {
	if x != nil {
		return x.Mobile
	}
	return ""
...
var file_user_proto_rawDesc = []byte{
	...
	0x70, 0x53, 0x69, 0x7a, 0x65, 0x22, 0x28, 0x0a, 0x0e, 0x4d, 0x6f, 0x62, 0x69, 0x6c, 0x65, 0x72,
	...
	0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x02, 0x69, 0x64, 0x22, 0x60, 0x0a, 0x0e,
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x32, 0xb6,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x35, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x42,
	0x79, 0x4d, 0x6f, 0x62, 0x69, 0x6c, 0x65, 0x12, 0x0f, 0x2e, 0x4d, 0x6f, 0x62, 0x69, 0x6c, 0x65,
	...
	0x6f, 0x72, 0x64, 0x12, 0x12, 0x2e, 0x50, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x43, 0x68,
...
var file_user_proto_goTypes = []interface{}{
	...
	(*MobilerRequest)(nil),    // 3: MobilerRequest
...
var file_user_proto_depIdxs = []int32{
	...
	3, // 2: User.GetUserByMobile:input_type -> MobilerRequest
...
type UserClient interface {
	...
	GetUserByMobile(ctx context.Context, in *MobilerRequest, opts ...grpc.CallOption) (*UserInfoResponse, error)
...
func (c *userClient) GetUserByMobile(ctx context.Context, in *MobilerRequest, opts ...grpc.CallOption) (*UserInfoResponse, error) {
...
type UserServer interface {
	...
	GetUserByMobile(context.Context, *MobilerRequest) (*UserInfoResponse, error)
...
func (*UnimplementedUserServer) GetUserByMobile(context.Context, *MobilerRequest) (*UserInfoResponse, error) {
...
func _User_GetUserByMobile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).GetUserByMobile(ctx, req.(*MobilerRequest))
	}
	return interceptor(ctx, in, info, handler)
}
